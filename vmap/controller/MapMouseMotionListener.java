 ...
 */
/*$Id: MapMouseMotionListener.java,v 1.3 2004/11/18 17:29:07 veghead Exp $ */
...
public class MapMouseMotionListener implements MouseMotionListener, MouseListener {
    ...
    private void showRecPopup(MouseEvent e) {
        JPopupMenu popup = null;
        popup = c.getMode().getModeController().getRecPopupMenu();
        if (popup != null ) {
    ...
    private void handlePopup(MouseEvent e) {
        ...
        if (e.isPopupTrigger()) {
            ...
            if(popup == null) { // no context popup found:
                // normal popup:
                popup = c.getFrame().getVmapMenuBar().getMapsPopupMenu();
            }
            popup.show(e.getComponent(),e.getX(),e.getY()); 
        }
    }
