 ...
 */
/*$Id: NodeMouseMotionListener.java,v 1.3 2005/03/02 12:22:18 veghead Exp $ */
...
public class NodeMouseMotionListener implements MouseMotionListener, MouseListener {
    ...
    public NodeMouseMotionListener(Controller controller) {
       c = controller; 
       if(logger == null)
           logger = c.getFrame().getLogger("vmap.controller.NodeMouseMotionListener");
    ...
    public void mouseReleased( MouseEvent e ) {
        ...
        if (e.getModifiers() == MouseEvent.BUTTON1_MASK ) {
            if (e.getClickCount() % 2 == 0) {
                ...
                Icon nIcon=((NodeView)e.getComponent()).getIcon();
                if  ((nIcon !=null) && (e.getX() <= (nIcon.getIconWidth()))) {
                    c.getMode().getModeController().openAttachment(e);
                } else {
