 ...
 */
/*$Id: MenuBar.java,v 1.6 2005/03/27 02:13:12 john_r Exp $ */
...
public class MenuBar extends JMenuBar {
    ...
    public MenuBar(Controller controller) {
    	...
    	viewmenu = new JMenu(c.getResourceString("view"));
    	insertmenu = new JMenu(c.getResourceString("insert_rec"));
    	formatmenu = new JMenu(c.getResourceString("format"));
    	...
    	//Mapsmenu
    	windowmenu = new JMenu(c.getResourceString("window"));
    ...
    public void updateInsertMenu() {
	insertmenu.removeAll();
        if ((c.getMode() != null) && (c.getMode().getModeInsertMenu() != null)) {
            copyMenuItems(c.getMode().getModeInsertMenu(), insertmenu);
        }
	...
	// What are we doing with all this then? :: john
	...
	if ((c.getMode() != null) && (c.getMode().getModeFormatMenu() != null)) {
	    copyMenuItems(c.getMode().getModeFormatMenu(), formatmenu);
	}
