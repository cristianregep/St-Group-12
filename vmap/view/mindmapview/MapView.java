 ...
 */
/*$Id: MapView.java,v 1.3 2005/04/16 14:02:27 veghead Exp $ */
...
// Clouds:
import vmap.view.mindmapview.CloudView;
// End Clouds
// links:
import vmap.modes.MindMapArrowLink;
...
import vmap.controller.NodeKeyListener;
import vmap.controller.NodeMouseMotionListener;
...
public class MapView extends JPanel implements Printable {
    ...
    public void selectAsTheOnlyOneSelected(NodeView newSelected) {
        ...
        controller.getMode().getModeController().setAvailableActions();
    }
...
//                     }
    ...
    private class MapModelHandler implements TreeModelListener {
        ...
        public void treeNodesInserted( TreeModelEvent e ) {
            ...
            // Vmap actually needs, which I find dubious.
