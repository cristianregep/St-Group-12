 ...
 */
/*$Id: ArrowLinkAdapter.java,v 1.1.1.1 2004/09/11 17:31:25 veghead Exp $ */

package vmap.modes;
import vmap.modes.LinkAdapter;
...
public abstract class ArrowLinkAdapter extends LinkAdapter implements MindMapArrowLink {
    ...
    public ArrowLinkAdapter(MindMapNode source,MindMapNode target,VmapMain frame)  {
