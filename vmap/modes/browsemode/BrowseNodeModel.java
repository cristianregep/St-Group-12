 ...
 */
/*$Id: BrowseNodeModel.java,v 1.1.1.1 2004/09/11 17:31:33 veghead Exp $ */
...
public class BrowseNodeModel extends NodeAdapter {
    ...
    public BrowseNodeModel(VmapMain frame) {
	super(frame);
	children = new LinkedList();
	setEdge(new BrowseEdgeModel(this,getFrame())); }
	    
    public BrowseNodeModel( Object userObject, VmapMain frame ) {
