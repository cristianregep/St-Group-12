 ...
 */
/*$Id: BrowseMode.java,v 1.3 2005/03/30 14:21:26 veghead Exp $ */

package vmap.modes.browsemode;

import vmap.main.VmapApplet;
...
public class BrowseMode implements Mode {
    ...
    public void activate() {
        ...
        if (map != null && map.startsWith("."))  {
            ...
            try {
                if(getController().getFrame() instanceof VmapApplet) {
                    VmapApplet applet = (VmapApplet) getController().getFrame();
