 ...
 */
/*$Id: LinkRegistryAdapter.java,v 1.1.1.1 2004/09/11 17:31:29 veghead Exp $ */

package vmap.modes;

import vmap.modes.MindMapNode;
import vmap.modes.mindmapmode.MindMapNodeModel;
...
//     protected MindMap map;
    ...
    private static java.util.logging.Logger logger = java.util.logging.Logger.getAnonymousLogger(); //getLogger("vmap.modes.LinkRegistryAdapter");
    ...
    protected String generateUniqueID(String proposedID) {
        ...
        do {
            if(!myProposedID.equals("")) {
                ...
                returnValue = "Vmap_Link_" + Integer.toString(ran.nextInt(2000000000));
            }
