 ...
 */
/*$Id: MindMapMode.java,v 1.3 2005/03/27 02:13:13 john_r Exp $ */
...
public class MindMapMode implements Mode {
	...
	return ((MindMapController)getModeController()).getFormatMenu();
    }

    public JMenu getModeInsertMenu() {
	return ((MindMapController)getModeController()).getInsertMenu();
    }
}
