 ...
 */
/*$Id: EdgeAdapter.java,v 1.1.1.1 2004/09/11 17:31:29 veghead Exp $ */
...
public abstract class EdgeAdapter extends LineAdapter implements MindMapEdge {
    ...
    public EdgeAdapter(MindMapNode target,VmapMain frame) {
        this(target, frame, "standardedgecolor", "standardedgestyle");
    }

    /** For derived classes.*/
    protected  EdgeAdapter(MindMapNode target,VmapMain frame, String standardColorPropertyString, String standardStylePropertyString)  {
