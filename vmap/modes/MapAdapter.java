 ...
 */
/*$Id: MapAdapter.java,v 1.3 2005/04/16 14:02:26 veghead Exp $ */
...
public abstract class MapAdapter implements MindMap {
    ...
    public MapAdapter (VmapMain frame) {
	this.frame = frame;
    }
    ...
    public abstract boolean save(File file,boolean present); 
   ...
   private Transferable copy(ArrayList selectedNodes, String inPlainText) {
    ...
    public void changeNode(MindMapNode node, String newText) {
        changeNode(node,"",newText);
    }

    public void changeNode(MindMapNode node, String newText, String newTitle) {
    ...
    private boolean find(LinkedList /*queue of MindMapNode*/ nodes, String what, boolean caseSensitive) {
       ...
       while (!nodes.isEmpty()) {
          ...
          String nodeText = caseSensitive ?
             node.getTitle() : node.getTitle().toLowerCase();
