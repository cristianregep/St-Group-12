 ...
 */
/*$Id: NodeAdapter.java,v 1.23 2005/05/29 13:14:25 veghead Exp $ */
...
//     protected String mLabel;
    ...
    protected LIPDate createdate;

    protected LIPDate updatedate;

    protected LIPStatus status;
...
//    // the meaning, at least not to me.
    ...
    /**
     * creates the createdate LIPStatus
     * @param tysourcet sourcetype for LIPStatus typename
     * @param tysourcev source content for LIPStatus typename
     * @param tyvalue value for LIPStatus typename
     */
    public void newStatus(String tysourcet,String tysourcev,String tyvalue) {
        status=new LIPStatus(tysourcet,tysourcev,tyvalue);
    }


    /**
     * creates the createdate LIPDate
     * @param tysourcet sourcetype for LIPDate typename
     * @param tysourcev source content for LIPDate typename
     * @param tyvalue value for LIPDate typename
     */
    public void newCreateDate(String tysourcet,String tysourcev,String tyvalue) {
        createdate=new LIPDate(tysourcet,tysourcev,tyvalue);
    }
     ...
     * @param date LIPDate
     */
    public void newCreateDate(LIPDate date) {
        createdate=date;
    }

    /**
     * creates the updatedate LIPDate
     * @param date LIPDate
     */
    public void newUpdateDate(LIPDate date) {
        updatedate=date;
    }
     ...
     * @param tyvalue value for LIPDate typename
     */
    public void newUpdateDate(String tysourcet,String tysourcev,String tyvalue) {
        updatedate=new LIPDate(tysourcet,tysourcev,tyvalue);
    }


    /**
     * set the updatedate datetime
     * @param datetime the datetime to set
     */
    public void setUpdateDate(String datetime) {
        updatedate.setDate(datetime);
    }

    /**
     * set the createdate datetime
     * @param datetime the datetime to set
     */
    public void setCreateDate(String datetime) {
        createdate.setDate(datetime);
    }


    /**
     * updates the updatedate with teh current datetime
     */
