 ...
 */
/*$Id: LineAdapter.java,v 1.1.1.1 2004/09/11 17:31:29 veghead Exp $ */
...
public abstract class LineAdapter implements MindMapLine {
    ...
    // Constructors
    //
    public LineAdapter(MindMapNode target,VmapMain frame, String standardColorPropertyString, String standardStylePropertyString) {
        this.frame = frame;
        this.target = target;
